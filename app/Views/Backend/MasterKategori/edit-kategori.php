		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form role="form" action="<?= base_url('admin/update-data-kategori') ?>" method="POST">
						<div class="form-group">
							<label>Nama Kategori</label>
							<input class="form-control" name="nama_kategori" value="<?= esc($kategori['nama_kategori']) ?>" required autofocus>
						</div>
